...
git push --tags moodle refs/remotes/origin/MOODLE_20_STABLE:MOODLE_20_STABLE
...
git push --tags github refs/remotes/origin/MOODLE_20_STABLE:MOODLE_20_STABLE
...
git push --tags gitorious refs/remotes/origin/MOODLE_20_STABLE:MOODLE_20_STABLE
